...
<body>
    ...
    <div class="container">
        <h1 class="text-center mb-4">English</h1>
    ...
    <script>
        ...
        function updateQuizButton(button, score, quizType) {
            if (score !== undefined && score !== null) {
                ...
                completedQuizzes[quizType] = true;
            }
        }
        ...
        document.addEventListener('DOMContentLoaded', function () {
            const quizTypes = {
                'lesson1-score': 'vocabulary',
                'lesson2-score': 'grammar',
                'lesson3-score': 'reading',
                'lesson4-score': 'writing',
                'lesson5-score': 'speaking'
            };
